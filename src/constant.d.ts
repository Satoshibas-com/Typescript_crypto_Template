...
declare global {
    ...
    class Web3 {
        ...
        public utils: {
            ...
            fromWei(value: number|string, unit: Web3.Unit): string;
            fromWei(value: BigNumber.BigNumber, unit: Web3.Unit): BigNumber.BigNumber;
            toWei(amount: number|string, unit: Web3.Unit): string;
            toWei(amount: BigNumber.BigNumber, unit: Web3.Unit): BigNumber.BigNumber;
            toBN(value: number|string): BigNumber.BigNumber;
